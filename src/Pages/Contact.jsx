...
const Contact = () => {
  ...
  return (
    <div class="relative flex items-top justify-center h-120 bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <form class="p-6 flex flex-col justify-center">
                        ...
                        <div class="flex flex-col mt-2">
                            ...
                            <textarea type="msg" name="msg" id="msg" placeholder="Message" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none" />
                        </div>


                        <button type="submit" class="md:w-32 bg-indigo-600 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-indigo-500 transition ease-in-out duration-300" onClick={handleSubmit}>
                            Submit
                        </button>
                    </form>
                </div>
