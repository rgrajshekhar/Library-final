...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
     ...
     navigate("/register", {state : {uemail : remail}});
  } 
  
  return (
    <div class="bg-gray-100">
    <div class="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center bg-gray-100">
            <div class="w-full lg:w-1/2">
                <div class="lg:max-w-lg">
                    ...
                    <div class="mt-8 space-y-5">
                        <p class="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                            ...
                            <span class="mx-2">Books Related to UPSC and state PCS</span>
                        </p>
                        ...
                        <p class="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                            ...
                            <span class="mx-2">Anytime Access to library from any where </span>
                        </p>
                ...
                <div class="w-full mt-8 bg-transparent border rounded-md lg:max-w-sm dark:border-gray-700 focus-within:border-blue-400 focus-within:ring focus-within:ring-blue-300 dark:focus-within:border-blue-400 focus-within:ring-opacity-40">
                    <form class="flex flex-col lg:flex-row" onSubmit={handleSubmit}>
                        <input name ="email" value={data.email} onChange={handleChange} type="email" placeholder="Enter your email address" class="flex-1 h-10 px-4 py-2 m-1 text-gray-700 placeholder-gray-400 bg-transparent border-none appearance-none dark:text-gray-200 focus:outline-none focus:placeholder-transparent focus:ring-0" /> 
